...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        galleryImageView = findViewById(R.id.galleryImageViwe);
        ...
        String [] items =  new String[]{"Select Category","Convoction", "Independence Day","Other Events"};
       ...
       selectImage.setOnClickListener((view)->{openGallery();});
        uploadImagebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (bitmap ==null){
                    Toast.makeText(UploadImage.this,"Please upload",Toast.LENGTH_SHORT).show();
