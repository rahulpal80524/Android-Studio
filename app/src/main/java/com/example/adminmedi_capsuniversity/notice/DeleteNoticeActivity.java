...
public class DeleteNoticeActivity extends AppCompatActivity {
    private RecyclerView deleteNoticeRecylerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteNoticeRecylerView=findViewById(R.id.deleteNoticeRecylerView);
        progressBar = findViewById(R.id.progressBar);

        reference = FirebaseDatabase.getInstance().getReference().child("Notice");


        deleteNoticeRecylerView.setLayoutManager(new LinearLayoutManager(this));
        deleteNoticeRecylerView.setHasFixedSize(true);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
              list = new ArrayList<>();
                ...
                deleteNoticeRecylerView.setAdapter(adapter);
            }
