...
import com.example.adminmedi_capsuniversity.NoticeData;
import com.example.adminmedi_capsuniversity.R;
import com.example.adminmedi_capsuniversity.UploadNotice;
...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items =  new String[]{"Select Category","Computer Science", "Mechenical","Physics","Chemistry"};
    ...
    private void checkValidation() {
        ...
        if(name.isEmpty()){
            ...
            addTeacherEmail.setError("Emapty");
            addTeacherEmail.requestFocus();
        }else if(post.isEmpty()){
            addTeacherPost.setError("Emapty");
            addTeacherPost.requestFocus();
        }else if (category.equals("Select Category")){
            Toast.makeText(this,"Please provide teacher",Toast.LENGTH_SHORT).show();
