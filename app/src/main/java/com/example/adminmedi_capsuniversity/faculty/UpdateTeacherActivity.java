...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private void updateData(String s) {
        ...
        reference.child(category).child(uniquekey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UpdateTeacherActivity.this,"Somthing wnet wrong",Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage() {
        ...
        uploadTask.addOnCompleteListener(UpdateTeacherActivity.this, (task)-> {
            ...
            if(task.isSuccessful()){
               ...
               // pd.dismiss();
                Toast.makeText(UpdateTeacherActivity.this,"Somthing went wrong",Toast.LENGTH_SHORT).show();
            }
